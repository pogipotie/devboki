-- Migration: Fix type mismatch in get_user_ban_history function
...
-- Add comment
COMMENT ON FUNCTION get_user_ban_history(UUID) IS 'Returns complete ban history for a specific user with proper type casting';